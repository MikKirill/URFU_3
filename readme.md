...
2. Дорабатываем C# код под оба куба 
...
## Выводы
По итогу, я научился работать с MLagent-ом, смог разобраться в его структуре, способах и возможностях применения, конфигурациях. Машинное обучение служит хорошим инструментом, чтобы задавать окружению или NPC тех качеств и способносей, для создания разнообразия опыта игрока, сделать его более увлекательным и живым, способным быть на одном уровне с игроком, даже если он развивается.
